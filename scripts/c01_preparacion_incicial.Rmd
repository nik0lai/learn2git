...
Primero partiremos creando una cuenta gratis en [GitHub](http://github.com). Necesitaremos un nombre de usuario, un correo electrónico y una contraseña.

## Instalación Git

### Cruza los dedos y revisa si Git ya está instalado
